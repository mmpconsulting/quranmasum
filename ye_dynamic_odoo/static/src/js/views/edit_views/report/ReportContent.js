...
"use strict";
    ...
    var ReportContent = Base.ContentBase.extend({
        ...
        renderReportView: function () {
            const self = this, {model, id} = this.urlState, {domain} = this.props, reportParams = {...this.reportData, context: {...this.action.context, active_id: false,
                    active_ids: [], active_model: model}};
            this['_rpc']({
                model: model,
                method: 'search_read',
                fields: ['id'],
